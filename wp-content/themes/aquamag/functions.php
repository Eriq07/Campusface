...
function aquamag_widgets_init() {
	...
	register_sidebar(
		array(
			'name'          => __( 'Main Slider', 'aquamag' ),
			'id'            => 'mainslider',
			'description'   => __( 'Main slides that appears on top.', 'aquamag' ),
			'before_widget' => '<div class="slider uk-clearfix"><div class="main-slider"><div id="mainFlexslider" class="flexslider"><ul class="slides">',
			'after_widget'  => '</ul></div></div><div class="thumb-slider uk-hidden-small"><div id="carousel" class="flexslider"><ul class="tabs" id="main-slider-control-nav"><li class=""></li><li class=""></li><li class="flex-active"></li><li class=""></li></ul></div></div></div>',
            'before_title'  => '<li class="">',
			'after_title'   => '</li>',
	...
	register_sidebar(
		array(
			'name'          => __( 'Advertisement after slide', 'aquamag' ),
			'id'            => 'belowslidead',
			'description'   => __( 'Main advert that appears after slide.', 'aquamag' ),
			'before_widget' => '<div class="add-section uk-clearfix">',
			'after_widget'  => '</div>',
            'before_title'  => '',
			'after_title'   => '',
